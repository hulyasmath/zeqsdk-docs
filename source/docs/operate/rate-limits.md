...
See your tier on the [Dashboard](https://zeq.dev/portal).
...
def check_daily_usage():
    ...
    response = requests.get(
        'https://zeq.dev/portal/api/usage',
        headers={'Authorization': f'Bearer {TOKEN}'}
    )
...
1. Visit the [Dashboard](https://zeq.dev/portal)
...
- [Overview](./overview)
- [curl Reference](../build/clients/curl)
