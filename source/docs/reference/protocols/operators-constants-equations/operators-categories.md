...
description: "Domain breakdown with operator counts, colors, and group labels."
---
...
Reach for **Operator Categories** when you need a operators, constants, equations primitive that:
...
The fastest path is a single HTTPS `GET` request to `/api/operators/categories` with a Bearer token. You can use cURL, JavaScript, Python, or any HTTP client — examples for all three are below. The response is JSON.
...
```bash
curl -X GET \
  https://www.zeq.dev/api/operators/categories \
...
```javascript
const res = await fetch("https://www.zeq.dev/api/operators/categories", {
  method: "GET",
  headers: {
...
func main() {
    req, _ := http.NewRequest("GET", "https://www.zeq.dev/api/operators/categories", nil)
...
public class ZeqCall {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest req = HttpRequest.newBuilder()
        .uri(URI.create("https://www.zeq.dev/api/operators/categories"))
...
int main(void) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://www.zeq.dev/api/operators/categories");
...
```php
<?php
$ch = curl_init("https://www.zeq.dev/api/operators/categories");
...
var req = URLRequest(url: URL(string: "https://www.zeq.dev/api/operators/categories")!)
req.httpMethod = "GET"
...
http.request{
    url = "https://www.zeq.dev/api/operators/categories",
    method = "GET",
    headers = {
...
```html
<script>
fetch("https://www.zeq.dev/api/operators/categories", {
  method: "GET",
  headers: {
...
```http
GET https://www.zeq.dev/api/operators/categories
...
Every response from `/api/operators/categories` carries:
