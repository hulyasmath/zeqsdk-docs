...
description: "All 7 core Zeq OS equations plus the ZTB1 timebase bridge. Master equation coefficients and protocol steps."
---

# Core Equations

> All 7 core Zeq OS equations plus the ZTB1 timebase bridge. Master equation coefficients and protocol steps.
...
All 7 core Zeq OS equations plus the ZTB1 timebase bridge. Master equation coefficients and protocol steps. It belongs to the **Operators, constants, equations** family and is callable as a single REST endpoint, a one-line SDK call, or via streaming where applicable.
