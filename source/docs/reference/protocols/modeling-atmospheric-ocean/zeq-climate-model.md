---
sidebar_position: 1
title: "ZeqClimate — Global Modeling"
description: "Climate modeling using atmospheric physics + fluid dynamics operator coupling. Energy balance, radiative forcing, and temperature projection via HULYAS solver."
---
...
Reach for **ZeqClimate — Global Modeling** when you need a modeling, atmospheric, ocean primitive that:
...
The fastest path is a single HTTPS `POST` request to `/api/climate/model/simulate` with a Bearer token. You can use cURL, JavaScript, Python, or any HTTP client — examples for all three are below. The response is JSON.
...
```bash
curl -X POST \
  https://www.zeq.dev/api/climate/model/simulate \
...
```javascript
const res = await fetch("https://www.zeq.dev/api/climate/model/simulate", {
  method: "POST",
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("POST", "https://www.zeq.dev/api/climate/model/simulate", bytes.NewBuffer(payload))
...
public class ZeqCall {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest req = HttpRequest.newBuilder()
        .uri(URI.create("https://www.zeq.dev/api/climate/model/simulate"))
...
int main(void) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://www.zeq.dev/api/climate/model/simulate");
...
```php
<?php
$ch = curl_init("https://www.zeq.dev/api/climate/model/simulate");
...
var req = URLRequest(url: URL(string: "https://www.zeq.dev/api/climate/model/simulate")!)
req.httpMethod = "POST"
...
http.request{
    url = "https://www.zeq.dev/api/climate/model/simulate",
    method = "POST",
    headers = {
...
```html
<script>
fetch("https://www.zeq.dev/api/climate/model/simulate", {
  method: "POST",
  headers: {
...
```http
POST https://www.zeq.dev/api/climate/model/simulate
...
Every response from `/api/climate/model/simulate` carries:
