---
sidebar_position: 4
title: "ZeqLifeSupport — ECLSS Modeling"
description: "Environmental Control and Life Support System modeling. Atmospheric composition, thermal regulation, water recycling — closed-loop systems via coupled ODEs."
---
...
Reach for **ZeqLifeSupport — ECLSS Modeling** when you need a orbital, trajectory, radiation, comms primitive that:
...
The fastest path is a single HTTPS `POST` request to `/api/space/lifesupport/simulate` with a Bearer token. You can use cURL, JavaScript, Python, or any HTTP client — examples for all three are below. The response is JSON.
...
```bash
curl -X POST \
  https://www.zeq.dev/api/space/lifesupport/simulate \
...
```javascript
const res = await fetch("https://www.zeq.dev/api/space/lifesupport/simulate", {
  method: "POST",
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("POST", "https://www.zeq.dev/api/space/lifesupport/simulate", bytes.NewBuffer(payload))
...
public class ZeqCall {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest req = HttpRequest.newBuilder()
        .uri(URI.create("https://www.zeq.dev/api/space/lifesupport/simulate"))
...
int main(void) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://www.zeq.dev/api/space/lifesupport/simulate");
...
```php
<?php
$ch = curl_init("https://www.zeq.dev/api/space/lifesupport/simulate");
...
var req = URLRequest(url: URL(string: "https://www.zeq.dev/api/space/lifesupport/simulate")!)
req.httpMethod = "POST"
...
http.request{
    url = "https://www.zeq.dev/api/space/lifesupport/simulate",
    method = "POST",
    headers = {
...
```html
<script>
fetch("https://www.zeq.dev/api/space/lifesupport/simulate", {
  method: "POST",
  headers: {
...
```http
POST https://www.zeq.dev/api/space/lifesupport/simulate
...
Every response from `/api/space/lifesupport/simulate` carries:
