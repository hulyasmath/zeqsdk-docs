---
sidebar_position: 6
title: "ZeqReentry — Atmospheric Entry"
description: "Atmospheric reentry heating and trajectory calculation using thermodynamics + fluid dynamics operators. Heat shield requirements and landing zone prediction."
---
...
Reach for **ZeqReentry — Atmospheric Entry** when you need a orbital, trajectory, radiation, comms primitive that:
...
The fastest path is a single HTTPS `POST` request to `/api/space/reentry/simulate` with a Bearer token. You can use cURL, JavaScript, Python, or any HTTP client — examples for all three are below. The response is JSON.
...
```bash
curl -X POST \
  https://www.zeq.dev/api/space/reentry/simulate \
...
```javascript
const res = await fetch("https://www.zeq.dev/api/space/reentry/simulate", {
  method: "POST",
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("POST", "https://www.zeq.dev/api/space/reentry/simulate", bytes.NewBuffer(payload))
...
public class ZeqCall {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest req = HttpRequest.newBuilder()
        .uri(URI.create("https://www.zeq.dev/api/space/reentry/simulate"))
...
int main(void) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://www.zeq.dev/api/space/reentry/simulate");
...
```php
<?php
$ch = curl_init("https://www.zeq.dev/api/space/reentry/simulate");
...
var req = URLRequest(url: URL(string: "https://www.zeq.dev/api/space/reentry/simulate")!)
req.httpMethod = "POST"
...
http.request{
    url = "https://www.zeq.dev/api/space/reentry/simulate",
    method = "POST",
    headers = {
...
```html
<script>
fetch("https://www.zeq.dev/api/space/reentry/simulate", {
  method: "POST",
  headers: {
...
```http
POST https://www.zeq.dev/api/space/reentry/simulate
...
Every response from `/api/space/reentry/simulate` carries:
