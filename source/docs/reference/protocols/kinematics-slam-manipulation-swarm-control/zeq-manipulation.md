---
sidebar_position: 3
title: "ZeqManipulation"
description: "Robotic grasp planning and manipulation. Force/torque control with HulyaPulse compliance, grasp quality metric, collision-free motion planning via RRT*."
---
...
Reach for **ZeqManipulation** when you need a kinematics, slam, manipulation, swarm, control primitive that:
...
The fastest path is a single HTTPS `POST` request to `/api/robotics/manipulation` with a Bearer token. You can use cURL, JavaScript, Python, or any HTTP client — examples for all three are below. The response is JSON.
...
```bash
curl -X POST \
  https://www.zeq.dev/api/robotics/manipulation \
...
```javascript
const res = await fetch("https://www.zeq.dev/api/robotics/manipulation", {
  method: "POST",
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("POST", "https://www.zeq.dev/api/robotics/manipulation", bytes.NewBuffer(payload))
...
public class ZeqCall {
  public static void main(String[] args) throws Exception {
    ...
    HttpRequest req = HttpRequest.newBuilder()
        .uri(URI.create("https://www.zeq.dev/api/robotics/manipulation"))
...
int main(void) {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "https://www.zeq.dev/api/robotics/manipulation");
...
```php
<?php
$ch = curl_init("https://www.zeq.dev/api/robotics/manipulation");
...
var req = URLRequest(url: URL(string: "https://www.zeq.dev/api/robotics/manipulation")!)
req.httpMethod = "POST"
...
http.request{
    url = "https://www.zeq.dev/api/robotics/manipulation",
    method = "POST",
    headers = {
...
```html
<script>
fetch("https://www.zeq.dev/api/robotics/manipulation", {
  method: "POST",
  headers: {
...
```http
POST https://www.zeq.dev/api/robotics/manipulation
...
Every response from `/api/robotics/manipulation` carries:
